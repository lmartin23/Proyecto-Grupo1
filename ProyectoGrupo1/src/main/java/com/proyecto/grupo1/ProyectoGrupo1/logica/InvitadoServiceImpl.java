...
public class InvitadoServiceImpl implements InvitadoService {
    ...
    public ObjResponse registrarCliente(DtRegistroCliente dt) {
        ...
        boolean existeDocumento = documentoRegistrado(dt.getDocumento());
    ...
    public boolean documentoRegistrado(String documento) {
        if (clienteDao.findClienteByDocumentoIgnoreCase(documento) != null || adminDao.findAdministradorByDocumentoIgnoreCase(documento) != null) {
            return true;
        }
        return false;
    }
