...
public class ClienteController {
    ...
    @RequestMapping(value = "api/cliente/registroVendedor", method = RequestMethod.POST)
    public ObjResponse insertar(@RequestBody DtRegistroVendedor dt) {
        return cliService.registrarVendedor(dt);
    }
}
